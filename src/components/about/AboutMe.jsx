    ...
    <div className="w-full md:w-1/2 text-zinc-400 px-6 border-r-[1px] border-r-zinc-800 flex items-center">
      <div className="py-6">
        ...
        <p className="leading-6 text-xl ">
          a Full-Stack Software Engineer who has recently completed my
          education at Microverse. With a strong foundation in JavaScript,
          React, Ruby, and Ruby on Rails, I am excited to embark on a career
          in the dynamic and ever-evolving field of software development.
        </p>
      </div>
    </div>
